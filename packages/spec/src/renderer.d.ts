 ...
 */
import type { Node, Graph, Edge, PortDef, PropDef, NodeDefinition } from './types';
/**
...
export interface RuntimeNode extends Node {
    /** Derived from graphInput boundary nodes (for subnets) */
    inputs?: PortDef[];
    /** Derived from graphOutput boundary nodes (for subnets) */
    outputs?: PortDef[];
    /** Derived from graphProp boundary nodes (for subnets) */
    props?: PropDef[];
...
export interface RuntimeGraph extends Omit<Graph, 'nodes'> {
    /** Derived from graphInput boundary nodes */
    inputs?: PortDef[];
    /** Derived from graphOutput boundary nodes */
    outputs?: PortDef[];
    /** Derived from graphProp boundary nodes */
    props?: PropDef[];
