...
const math_definitions_1 = require("../__fixtures__/math-definitions");
const ui_definitions_1 = require("../__fixtures__/ui-definitions");
describe('evaluate', () => {
    describe('math operations', () => {
        it('should evaluate a simple add graph', async () => {
            ...
            const result = await (0, evaluate_1.evaluate)(graph, {
                definitions: math_definitions_1.mathDefinitions,
                outputNode: 'add',
                outputPort: 'sum'
            });
        ...
        it('should use lazy evaluation (only evaluate needed nodes)', async () => {
            ...
            const trackingDefs = math_definitions_1.mathDefinitions.map(def => ({
                ...def,
                impl: (inputs, props) => {
            ...
            await (0, evaluate_1.evaluate)(graph, {
    ...
    describe('UI vdom generation', () => {
        it('should generate a simple page vdom', async () => {
            ...
            const result = await (0, evaluate_1.evaluate)(graph, {
                definitions: ui_definitions_1.uiDefinitions,
                outputNode: 'page',
                outputPort: 'element'
            });
    ...
    describe('subnet evaluation', () => {
        ...
        it('should produce vdom from a flat graph', async () => {
            ...
            const result = await (0, evaluate_1.evaluate)(flatGraph, {
                definitions: ui_definitions_1.uiDefinitions,
                outputNode: 'page',
                outputPort: 'element'
            });
        ...
        it('should produce identical vdom from a graph with subnet', async () => {
            ...
            const result = await (0, evaluate_1.evaluate)(graphWithSubnet, {
                definitions: ui_definitions_1.uiDefinitions,
                outputNode: 'page',
                outputPort: 'element'
            });
        ...
        it('should handle subnet with inputs', async () => {
            ...
            const result = await (0, evaluate_1.evaluate)(graphWithSubnetInput, {
                definitions: ui_definitions_1.uiDefinitions,
                outputNode: 'page',
                outputPort: 'element'
            });
